...
import (
	...
	grpc_client "github.com/HeadGardener/TaxiApp/user-service/internal/grpc-client"
	grpc_handler "github.com/HeadGardener/TaxiApp/user-service/internal/handlers/grpc-handler"
	http_handler "github.com/HeadGardener/TaxiApp/user-service/internal/handlers/http-handler"
	grpc_server "github.com/HeadGardener/TaxiApp/user-service/internal/server/grpc-server"
	http_server "github.com/HeadGardener/TaxiApp/user-service/internal/server/http-server"
	"github.com/HeadGardener/TaxiApp/user-service/internal/services"
...
func main() {
	...
	var (
		...
		walletService      = services.NewWalletService(walletStorage, userStorage)
		transactionService = services.NewTransactionService(transactionStorage, walletStorage)
		orderService       = services.NewOrderService(client, orderStorage, tripStorage)
		tripService        = services.NewTripService(tripStorage)

		identityService = services.NewIdentityService(userStorage, tokenStorage)
	)

	handler := http_handler.NewHandler(identityService,
		userService,
		walletService,
		transactionService,
		tripService,
	...
	grpcHandler := grpc_handler.NewOrderHandler(orderService)
